...
#include "command_buffers_fragment_shader/command_buffers_fragment_shader.hpp"
#include "command_buffers_vertex_shader/command_buffers_vertex_shader.hpp"
...
{
  VkShaderModule vertShaderModule = *(createShaderModule(command_buffers_vertex_shader()).release());
  VkShaderModule fragShaderModule = *(createShaderModule(command_buffers_fragment_shader()).release());
