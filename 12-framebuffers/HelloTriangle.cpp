...
#include "framebuffers_fragment_shader/framebuffers_fragment_shader.hpp"
#include "framebuffers_vertex_shader/framebuffers_vertex_shader.hpp"
...
{
  VkShaderModule vertShaderModule = *(createShaderModule(framebuffers_vertex_shader()).release());
  VkShaderModule fragShaderModule = *(createShaderModule(framebuffers_fragment_shader()).release());
