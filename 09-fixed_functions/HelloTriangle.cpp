...
#include "fixed_functions_fragment_shader/fixed_functions_fragment_shader.hpp"
#include "fixed_functions_vertex_shader/fixed_functions_vertex_shader.hpp"
...
{
  VkShaderModule vertShaderModule = createShaderModule(fixed_functions_vertex_shader());
  VkShaderModule fragShaderModule = createShaderModule(fixed_functions_fragment_shader());
