...
#include "graphics_pipeline_fragment_shader/graphics_pipeline_fragment_shader.hpp"
#include "graphics_pipeline_vertex_shader/graphics_pipeline_vertex_shader.hpp"
...
{
  VkShaderModule vertShaderModule = *(createShaderModule(graphics_pipeline_vertex_shader()).release());
  VkShaderModule fragShaderModule = *(createShaderModule(graphics_pipeline_fragment_shader()).release());
